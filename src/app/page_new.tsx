...
export const metadata: Metadata = {
  title: "Toolizio - Free Online Tools | CPF, CNPJ, Password Generator & More",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <CategoryNav categories={toolCategories} />
          ...
          <section key={categoryKey} className="mb-16" id={categoryKey}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {category.tools.map((tool) => (
                <ToolCard key={tool.href} tool={tool} category={category} />
              ))}
            </div>
          </section>
        ))}
